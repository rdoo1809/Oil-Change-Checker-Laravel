<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            @if(!$selectedCar)
                <h4>Select a Car to get started or <a href="{{route('cars.index', ['add_new_car' => 1])}}">Add a New
                        Car</a></h4>
...
{{--                    <a href="{{route('cars.show')}}">view car history</a></h4>--}}
                ...
                <form action="{{ route('vehikl.store') }}" method="POST">
                    ...
                    <x-oil-change-form-input form-field="current_odometer" label-text="Current Odometer"
                                             input-type="number"
                    ...
                    <x-oil-change-form-input form-field="previous_oil_change_date"
                                             label-text="Date of Previous Oil Change"
                                             input-type="date"
